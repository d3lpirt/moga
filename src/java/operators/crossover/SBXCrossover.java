 ...
 * Date: 28/11/13 Time: 22:19
 */
public class SBXCrossover<T extends Chromosome> implements Crossover<T> {
    ...
    public SBXCrossover(Class<T> chromosomeClass) {
        this.probability = 0.9;
        this.distributionIndex = 20.0;
        this.chromosomeClass = chromosomeClass;
    }

    public SBXCrossover(Class<T> chromosomeClass, double probability, double distributionIndex) {
            ...
            for (int i = 0; i < problem.getNumberOfVariables(); i++) {
                ...
                if (randomGenerator.nextDouble() <= 0.5) {
                    if (Math.abs(valueX1 - valueX2) > EPS) {
                        ...
                        offspring1.setVariable(i, valueX1);
                        offspring2.setVariable(i, valueX2);
                    }
                } else {
                    offspring1.setVariable(i, valueX2);
                    offspring2.setVariable(i, valueX1);
                }
            }
        }
